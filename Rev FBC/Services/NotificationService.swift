...
class NotificationService {
    ...
    func addNotification(forEvent event: Event) {
        ...
        let dateComponents = DateComponents(year: event.startDate.year, month: event.startDate.month, day: event.startDate.day, hour: event.startDate.hour, minute: event.startDate.minute, second: event.startDate.second)
    ...
    func checkNotifications(forEvent event: Event) {
        getNotifications().then({ notifications in
            if !notifications.isEmpty {
                ...
                if trig.dateComponents.day == event.startDate.day, trig.dateComponents.minute == event.startDate.minute {
